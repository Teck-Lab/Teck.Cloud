...
namespace Web.Edge.UnitTests.Middleware;
...
public sealed class EdgeMiddlewareBehaviorTests
{
    ...
    {
        Type optionsType = GetTypeByName("Web.Edge.Services.EdgeRouteSecurityOptions");
    ...
    {
        Type optionsType = GetTypeByName("Web.Edge.Services.EdgeTenantOptions");
    ...
    {
        Type middlewareType = GetTypeByName("Web.Edge.Middleware.AdminRouteAuthorizationMiddleware");
    ...
    {
        Type middlewareType = GetTypeByName("Web.Edge.Middleware.TenantEnforcementMiddleware");
