// <copyright file="PreviewDeviceAssignmentValidatorTests.cs" company="TeckLab">
...
public sealed class PreviewDeviceAssignmentValidatorTests
{
    private readonly PreviewDeviceAssignmentValidator _validator = new();

    private static PreviewDeviceAssignmentRequest CreateRequest(
        string deviceId = "disp-001",
        string locationNodeId = "shelf-a1",
        IReadOnlyList<PreviewDeviceAssignmentZoneRequest>? zones = null) => new()
    {
        DeviceId = deviceId,
        LocationNodeId = locationNodeId,
        Zones = zones ??
        [
            new PreviewDeviceAssignmentZoneRequest { ZoneIndex = 1, ProductId = "prod-001" },
            new PreviewDeviceAssignmentZoneRequest { ZoneIndex = 2, ProductId = "prod-002" },
        ],
    };
    ...
    {
        // Arrange
        var request = new PreviewDeviceAssignmentRequest
        {
            DeviceId = "disp-001",
    ...
    {
        // Arrange
        var zones = new List<PreviewDeviceAssignmentZoneRequest>
        {
