...
public sealed class DeactivateTenantCommandHandlerTests
{
    private readonly ITenantWriteRepository tenantRepository;
    private readonly IUnitOfWork unitOfWork;
    private readonly DeactivateTenantCommandHandler sut;

    public DeactivateTenantCommandHandlerTests()
    {
        this.tenantRepository = Substitute.For<ITenantWriteRepository>();
        this.unitOfWork = Substitute.For<IUnitOfWork>();
        this.sut = new DeactivateTenantCommandHandler(this.tenantRepository, this.unitOfWork);
    }
    ...
    public async Task Handle_ShouldDeactivateTenant_WhenTenantExists()
    {
        ...
        var tenant = CreateTenant("deactive-test");
        ...
        // Act
        ErrorOr<TenantResponse> result = await this.sut.Handle(new DeactivateTenantCommand(tenantId), TestContext.Current.CancellationToken);
