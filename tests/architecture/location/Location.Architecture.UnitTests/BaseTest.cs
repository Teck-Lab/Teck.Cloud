...
namespace Location.Arch.UnitTests
{
    public abstract class BaseTest
    {
        protected static readonly Assembly DomainAssembly = Assembly.Load("Location.Domain");
        protected static readonly Assembly ApplicationAssembly = Assembly.Load("Location.Application");
        protected static readonly Assembly InfrastructureAssembly = Assembly.Load("Location.Infrastructure");
        protected static readonly Assembly PresentationAssembly = Assembly.Load("Location.Api");
    }

    public abstract class ArchUnitBaseTest : BaseTest
    {
        private const string DomainNamespacePattern = @"^Location\.Domain(?:\..*)?$";
        private const string ApplicationNamespacePattern = @"^Location\.Application(?:\..*)?$";
        private const string InfrastructureNamespacePattern = @"^Location\.Infrastructure(?:\..*)?$";
        private const string PresentationNamespacePattern = @"^Location\.Api(?:\..*)?$";
