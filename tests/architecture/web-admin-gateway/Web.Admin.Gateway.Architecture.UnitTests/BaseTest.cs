...
namespace Web.Admin.Gateway.Arch.UnitTests
{
    public abstract class BaseTest
    {
        protected static readonly Assembly PresentationAssembly = Assembly.Load("Web.Admin.Gateway");
    }

    public abstract class ArchUnitBaseTest : BaseTest
    {
        private const string PresentationNamespacePattern = @"^Web.Admin.Gateway(?:\..*)?$";
