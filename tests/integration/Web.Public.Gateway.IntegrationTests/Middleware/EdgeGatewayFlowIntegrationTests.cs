...
namespace Web.Public.Gateway.IntegrationTests.Middleware;
...
public sealed class EdgeGatewayFlowIntegrationTests
{
    ...
    private static async Task<TestHostApp> CreateHostAsync(RouteConfig routeConfig, GrpcLookupMode lookupMode)
    {
        ...
        Type edgeTenantOptionsType = ResolveType("Web.Public.Gateway.Services.EdgeTenantOptions");
        Type edgeRouteSecurityOptionsType = ResolveType("Web.Public.Gateway.Services.EdgeRouteSecurityOptions");
