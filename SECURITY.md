...
#### 2. Dependency-Track + SecObserve (Operational Risk Tracking)

**Purpose**: Continuous dependency and vulnerability monitoring across releases and internal PR builds
...
- `DEPENDENCYTRACK_PORT` (optional, defaults to `443`)
- `DEPENDENCYTRACK_PROTOCOL` (optional, defaults to `https`)
- `SO_API_BASE_URL`
