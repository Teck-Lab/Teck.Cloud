# v0.22.24 (Fri May 01 2026)

#### ⚠️ Pushed to `main`

- Update Program.cs ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- Downgrade Scalar.AspNetCore to 2.13.8 ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
# v0.22.17 (Sat Apr 25 2026)

#### ⚠️ Pushed to `main`

- Downgrade Scalar.AspNetCore to 2.13.22 ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
# v0.22.16 (Sat Apr 25 2026)

#### ⚠️ Pushed to `main`

- Use Keycloak org ID; enable trim analyzer ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- Update TenantWriteRepository.cs ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
# v0.22.8 (Thu Apr 23 2026)

#### ⚠️ Pushed to `main`

- Update Program.cs ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
- Update httproute.yaml ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- Update Program.cs ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
- Use single Redis headless host in dev configs ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
- Add RabbitMQ vhost to development env vars ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- Use Containerfile instead of Dockerfile ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- Merge branch 'main' of https://github.com/Teck-Lab/Teck.Cloud ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
- ci: added deployment files ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- fix: update badge links in README for consistency and clarity ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
# v0.20.0 (Sat Mar 14 2026)

#### 🚀 Enhancement

- feat: add coverage report workflow and update README with badges ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
- fix: lowercase repository owner for Docker image names ([@CaptainPowerTurtle](https://github.com/CaptainPowerTurtle))
...
# v0.9.2 (Sun Feb 08 2026)



---

# v0.8.4 (Sun Feb 08 2026)
