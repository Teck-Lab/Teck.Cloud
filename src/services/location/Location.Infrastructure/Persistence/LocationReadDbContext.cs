// <copyright file="LocationReadDbContext.cs" company="TeckLab">
...
/// <summary>
/// EF Core read context for template font metadata and display model definitions.
/// </summary>
/// <param name="options">DbContext options.</param>
/// <param name="tenantAccessor">Finbuckle multi-tenant accessor; null during design-time and code generation.</param>
public sealed class LocationReadDbContext(
    DbContextOptions<LocationReadDbContext> options,
