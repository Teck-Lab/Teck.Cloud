...
namespace Product.Infrastructure.Persistence.Configurations.Read;

/// <summary>
/// EF Core entity configuration for <see cref="Domain.Entities.ProductAggregate.Product"/> on the read side.
/// </summary>
